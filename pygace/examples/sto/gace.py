...
from pygace.examples.hfo2.algorithms import hfo2_ga, crossover
...
def initial():
    ...
    toolbox.register("mate", crossover,select=3,cross_num=6)
...
def single_run( mission_name, iter):
    ...
    res = hfo2_ga(pop, toolbox, cxpb=0.5, mutpb=1.0,
                  ngen=90, stats=stats,halloffame=hof, verbose=True,
...
if __name__ == "__main__":
    ...
    # mission_name = 'test-crossmethod'
    # for cross_method in range(1,7):
