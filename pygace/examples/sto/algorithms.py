...
def sto_varAnd(population, toolbox, cxpb, mutpb):
...
def sto_ga(population, toolbox, cxpb, mutpb, ngen, stats=None,
    ...
    for gen in range(start_gen+1, ngen + 1):
        ...
        offspring = sto_varAnd(offspring, toolbox, cxpb, mutpb)
...
def crossover(indiv1, indiv2,select=1,cross_num=8):
    """
